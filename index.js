...
function get20s(data) {
    ...
    for (i = 0; i < data.length; i++) {
        let year = data[i].years.split('-');
        let beginYear = year[0].trim();
        let endYear = year[1].trim();
 ...
 */
function removeArtist(arrays, index) {
    arrays.splice(0, index);
