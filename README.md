...
1. How would you describe acessibility on the web to someone new to programming?
 - Accessiblitiy is basically making the webpage accessible to everyone. It is to make your webpage easily understanable or make it user-friendly by using different types of accessiblilty helper codes. 
2. Talk about 3 different things you can do to ensure your website is accessible.
a. you can add Alternate text to the pics that cannot load.
b. using semantic HTML codes.
c. Using Color Contrast. 
3. How would you explain the concept of a variable to someone new to programming?
- variable is used to assign, store, change or use the data in the codes. 
4. What is the purpose of using functions in code?
- function is used to increase the reuseablity of the codes. 
